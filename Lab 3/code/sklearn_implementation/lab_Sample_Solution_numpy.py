...
def get_entropy_of_dataset(data: np.ndarray):
    """
...
def get_avg_info_of_attribute(data: np.ndarray, attribute: int):
    """
...
def get_information_gain(data: np.ndarray, attribute: int):
    """
